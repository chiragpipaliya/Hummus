...
public class ShowreviewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		icon = (CircularImageView) findViewById(R.id.list_icon);
		imageLoader = new ImageLoader(ShowreviewActivity.this);
		windowManager = (WindowManager) ShowreviewActivity.this
		...
		if (NetworkManager.isInternetConnected(ShowreviewActivity.this)) {
	...
	class JSONShowReview extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(ShowreviewActivity.this);
