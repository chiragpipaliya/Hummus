...
public class Mapshowreviewactivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageLoader=new ImageLoader(Mapshowreviewactivity.this);
		windowManager=(WindowManager) Mapshowreviewactivity.this
				.getSystemService(Context.WINDOW_SERVICE);
		width = windowManager.getDefaultDisplay().getWidth();
		height = windowManager.getDefaultDisplay().getHeight();
		event_title.setText(Share.sm_name);
		imageLoader.DisplayImage(Share.sm_image, icon);
		...
		if (NetworkManager.isInternetConnected(Mapshowreviewactivity.this)) {
	...
	class JSONShowReview extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(Mapshowreviewactivity.this);
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		super.onBackPressed();
		Intent intent=new Intent(Mapshowreviewactivity.this,MapdetailsActivity.class);
