...
public class ListdetailsActivity extends FragmentActivity implements
		OnClickListener {
	...
	String picturePath, review,imageUri,date;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv_icon = (CircularImageView) findViewById(R.id.list_icon);
		
		 callbackManager = CallbackManager.Factory.create();
	        shareDialog = new com.facebook.share.widget.ShareDialog(this);

		windowManager = (WindowManager) ListdetailsActivity.this
		...
		// ll_rate.getLayoutParams().width=(int)(width*0.1);
		...
		et_review.setOnEditorActionListener(new OnEditorActionListener() {
			...
			public boolean onEditorAction(TextView v, int actionId,
				...
				if (actionId == EditorInfo.IME_ACTION_DONE) {
					...
					if(review.equals("")){
						CustomDailog.showAlertDialog(ListdetailsActivity.this, "Message", "Please add review");
					}else{
						if (NetworkManager.isInternetConnected(ListdetailsActivity.this)) {
...
//		});
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		super.onBackPressed();
		Intent intent=new Intent(ListdetailsActivity.this,ListActivity.class);
...
//	}
	private void ShowDialog() {
		...
		final Dialog dialog = new Dialog(ListdetailsActivity.this);
		LayoutInflater inflater = getLayoutInflater();
		final View ratingView = inflater.inflate(R.layout.row_rating, null);
		...
		b_submitrate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(r.getRating()!=0){
					...
					customDailog.showAlertDialog(ListdetailsActivity.this, "Message", "Please give rating");
				}
			}
		});
	...
	private void addGoogleMap() {
		...
		if (googlemap == null) {
			...
			findViewById(R.id.map).setBackgroundResource(R.drawable.border);
	...
	public class Jsontask extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(ListdetailsActivity.this);
...
//					CustomDailog.showAlertDialog(ListdetailsActivity.this, "Message", "Your rating saved");
	...
	public void onClick(View v) {
		...
		if(v==tv_showreview){
			...
			Intent intent=new Intent(ListdetailsActivity.this,ShowreviewActivity.class);
			startActivity(intent);
		}
	}
...
////			shareIntent.putExtra(Intent.EXTRA_TEXT, "Address:"+Share.s_addre);
////			shareIntent.putExtra(Intent.EXTRA_TEXT, "Telephone:"+Share.s_telephone);
//			shareIntent.setType("*/*");
...
//		}
			...
			public void onClick(View v) {
				...
				if (NetworkManager.isInternetConnected(ListdetailsActivity.this)) {
					if (com.facebook.share.widget.ShareDialog.canShow(ShareLinkContent.class)) {
						...
						.setContentDescription("Name:"+Share.s_name + "\n" +"Address:"+Share.s_addre + "\n" + "Telephone:"+Share.s_telephone)
	...
	protected void startNewActivity(String packageName, String appname) {
		// TODO Auto-generated method stub
		Intent intent = ListdetailsActivity.this.getPackageManager()
	...
	class JSONADDImage extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			HashMap<String, String> param = new HashMap<String, String>();
			param.put("event_id", String.valueOf(Share.s_id));
			Log.e("tag", "Imagename" + picturePath);
			response = Webservice
					.Send_message(
							param,
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (data.getString("success").equals("1")) {
					...
					// AlertDialog.Builder(ListdetailsActivity.this);
					CustomDailog.showAlertDialog(ListdetailsActivity.this, "Photo Upload", "Successfully");
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (data.getString("success").equals("1")) {
					...
					CustomDailog.showAlertDialog(ListdetailsActivity.this, "Review Send", "Successfully");
